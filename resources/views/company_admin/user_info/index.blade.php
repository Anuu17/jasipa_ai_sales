...
<div class="page">
    ...
    <div class="page-wrapper">
        <div class="d-none d-md-flex ms-3 p-3">
            <a type="button" class="btn btn-primary" href="{{route('company_user.create')}}">
                ...
                @foreach ($userInfo as $user)
                    <tr>
                        ...
                        <td class="text-center" >
                            <a href="{{ route('company_users.edit', $user->id) }}" class="btn btn-custom btn-dark me-2">
                            ...
                            <form action="{{ route('company_user.destroy', $user->id) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
