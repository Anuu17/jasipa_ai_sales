...
<div class="page">
    ...
    <div class="page-wrapper">
        <div class="d-flex justify-content-between align-items-center ms-3 p-3">
            ...
            <div>
                <a type="button" class="btn btn-primary" href="{{ route('admin.company_info.create') }}">
                ...
                @foreach ($companyInfo as $company)
                    <tr>
                        ...
                        <td class="text-center" >
                            <a href="{{ route('admin.company_info.edit', $company->id) }}" class="btn btn-custom btn-dark me-2">
                            ...
                            <form action="{{ route('admin.company_info.destroy', $company->id) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-custom btn-danger" onclick="return confirm('Are you sure you want to delete this Company?')">
