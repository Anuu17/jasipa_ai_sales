    ...
    <div class="page-wrapper">
        ...
        <div class="card card-md">
            <div class="card-body">
                ...
                <form action="{{ route('admin.user_info.update', $user->id) }}" method="POST" autocomplete="off" enctype="multipart/form-data" novalidate>
                    @csrf
                    @method('put')
                    <div class="mb-3">
                        <div class="img text-center">
                            @if($user->image)
                                <img src="{{$user->image}}" alt="profile" class="img-fluid rounded-circle" style="width: 150px; height: 150px; object-fit: cover;">
                            @else
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" value="{{$user->name}}" class="form-control" placeholder="名前" autocomplete="off" required>
                        <x-input-error :messages="$errors->get('name')" class="mt-2" />
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Email address</label>
                        <input type="email" name="email" value="{{$user->email}}" class="form-control" placeholder="your@email.com" autocomplete="off" required>
