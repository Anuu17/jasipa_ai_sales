                                            ...
                                            <form action="{{ route('chat_screen.prompt.save') }}" method="POST" class="w-100">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <h4 class="mb-1 d-flex align-items-center">
                                                        プロンプト
                                                        <button id="changePrompt" type="button" class="btn btn-link text-muted p-0 ms-2 border-0 shadow-none">
                                                            ...
                                                            <svg id="eyeClosed" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-eye-off" style="display: none;">
                                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                                                <path d="M10 12a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" />
                                                                <path d="M3 3l18 18" />
                                                                <path d="M21 12c-2.4 4 -5.4 6 -9 6c-3.6 0 -6.6 -2 -9 -6c2.4 -4 5.4 -6 9 -6c3.6 0 6.6 2 9 6" />
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.is_success) {
                        ...
                        $('#project-details').prop('disabled', true);
                        $('#skills-experience').prop('disabled', true);
...
<script>
        ...
        $(document).ready(function () {
        $("#changePrompt").click(function (event) {
